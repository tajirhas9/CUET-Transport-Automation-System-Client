...
declare function bindOptionWatchers(config: Configuration, vueInstance: Pick<IVue, "$watch">, innerChanges: Record<string, any>): void;
declare function setEmitOptionChangedFunc(config: Configuration, vueInstance: Pick<IVue, "$" | "$props" | "$emit" | "$options">, innerChanges: Record<string, any>): void;
