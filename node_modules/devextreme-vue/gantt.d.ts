...
declare const DxGanttHeaderFilter: any;
...
declare const DxScaleTypeRange: any;
declare const DxSorting: any;
declare const DxStringLengthRule: any;
declare const DxStripLine: any;
declare const DxTasks: any;
declare const DxTexts: any;
declare const DxToolbar: any;
declare const DxToolbarItem: any;
declare const DxValidation: any;
declare const DxValidationRule: any;
export default DxGantt;
export { DxGantt, DxAsyncRule, DxButton, DxColumn, DxColumnHeaderFilter, DxCompareRule, DxContextMenu, DxContextMenuItem, DxCustomRule, DxDependencies, DxEditing, DxEmailRule, DxFilterRow, DxFormat, DxFormItem, DxGanttHeaderFilter, DxHeaderFilter, DxItem, DxLabel, DxLookup, DxNumericRule, DxOperationDescriptions, DxPatternRule, DxRangeRule, DxRequiredRule, DxResourceAssignments, DxResources, DxScaleTypeRange, DxSorting, DxStringLengthRule, DxStripLine, DxTasks, DxTexts, DxToolbar, DxToolbarItem, DxValidation, DxValidationRule };
